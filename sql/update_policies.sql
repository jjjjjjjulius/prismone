...
drop policy if exists "Users can update their own beliefs" on beliefs;
drop policy if exists "Users can update evidence for their beliefs" on evidence;
...
create policy "Users can update evidence for their beliefs"
